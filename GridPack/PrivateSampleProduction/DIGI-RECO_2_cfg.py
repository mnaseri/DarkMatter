...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:DIGI-RECO_step1.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:DIGI-RECO.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:DIGI-RECO_inDQM.root'),
