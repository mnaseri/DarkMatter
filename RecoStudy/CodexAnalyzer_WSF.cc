        ...
        for (Int_t i = 0; i < nentries_wtn; i++) {
            ...
            for  (int imu=0 ; imu < nMu; imu++){
                ...
                for (int ijet= 0 ; ijet < nJet ; ijet++){
                    ...
                    bool MT40 = tmass_MuMet > 40 && tmass_MuMet < 60;
                    bool MT60 = tmass_MuMet > 60 && tmass_MuMet < 80;
                    bool MT80 = tmass_MuMet > 80 && tmass_MuMet < 100;
                    bool MT100 = tmass_MuMet > 100 && tmass_MuMet < 120;
                    bool MT120 = tmass_MuMet > 120 && tmass_MuMet < 140;
                    bool MT140 = tmass_MuMet > 140 && tmass_MuMet < 170;
                    bool MT170 = tmass_MuMet > 170 && tmass_MuMet < 200;
                    
                    
                    bool MT_category[size_mTCat] = {NoMT,LoWMT, MT40,MT60, MT80,MT100, MT120,MT140, MT170};
                    std::string MT_Cat[size_mTCat] = {"_NoMT", "_LowMT","_MT40","_MT60","_MT80","_MT100","_MT120","_MT140","_MT170"};
